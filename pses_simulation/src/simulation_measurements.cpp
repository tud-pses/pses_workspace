...
void odomCallback(const nav_msgs::Odometry::ConstPtr& odom_msg, nav_msgs::Odometry* odom){
        *odom = *odom_msg;
}
...
int main(int argc, char **argv){
        ...
        ros::Subscriber robotInfo = nh.subscribe<nav_msgs::Odometry>("odom", 10, boost::bind(odomCallback, _1, &odom));
        ...
        Y_out_statistics << YAML::Value << odom.pose.pose.position.z;
