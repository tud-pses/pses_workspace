...
void checkKinectParameter(ros::NodeHandle& nh, PsesUcBoard& board,
                          ros::Time& timer, double seconds)
{
...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber command_sub = nh.subscribe<pses_basis::Command>(
      ...
      std::bind(commandCallback, std::placeholders::_1, &board));
  ros::Publisher sensor_pub =
      nh.advertise<pses_basis::SensorData>("pses_basis/sensor_data", 10);
